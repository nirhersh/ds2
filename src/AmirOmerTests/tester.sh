...
for i in InOutTests/inFiles/test*.in
do
	...
	printf "test $i >>>  "
	./InOutTester < $i > InOutTests/outFiles/test${i//[^0-9]/}.out
	diff InOutTests/outFiles/test${i//[^0-9]/}.out InOutTests/outFiles/test${i//[^0-9]/}.result
